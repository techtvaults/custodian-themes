...
$ch2_footer_copyright_txt = get_theme_mod('ch2_footer_copyright_txt');
$ch2_footer_txt = get_theme_mod('ch2_footer_txt');
$ch2_footer_social = get_theme_mod('ch2_footer_social');
...
<footer class="host-app-footer-section">
    ...
    <div class="copy-right">
        <div class="container">
            <p> <?php if (!empty($ch2_footer_copyright_txt)){?>
                    <?php echo wp_kses($ch2_footer_copyright_txt, $allowed_html); ?>
                <?php } else{ ?>
                    © 2020 <span>appilo</span> All rights reserved
                <?php }?>
            </p>
            <?php if ($ch2_footer_social){ ?>
