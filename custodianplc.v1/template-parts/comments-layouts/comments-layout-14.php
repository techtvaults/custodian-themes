...
<div itemscope itemtype="<?php echo esc_attr($protocol);?>schema.org/Comment" id="comments" class="comments-area">
    <?php if ( have_comments() ) : ?>
            <div class="group-title"><h4><?php comments_number();?></h4></div>

                <?php
                wp_list_comments("callback=topapp_comments_list");
                ?>
